...
// Hover effects
document.querySelectorAll('button, .card, .stat, a, .timeline-item, .risk-card, .team-card').forEach(el => {
...
createParticles('particles6', 15, 'rgba(129,140,248,0.25)');
createParticles('particles7', 18, 'rgba(52,211,153,0.3)');
createParticles('particles8', 12, 'rgba(251,191,36,0.3)');
createParticles('particles9', 16, 'rgba(244,114,182,0.35)');
createParticles('particles10', 14, 'rgba(129,140,248,0.3)');
createParticles('particles11', 18, 'rgba(99,102,241,0.3)');
createParticles('particles12', 15, 'rgba(244,114,182,0.3)');
createParticles('particles13', 12, 'rgba(251,191,36,0.3)');
createParticles('particles14', 16, 'rgba(52,211,153,0.3)');
createParticles('particles15', 14, 'rgba(251,146,60,0.3)');
createParticles('particles16', 18, 'rgba(129,140,248,0.3)');
createParticles('particles17', 15, 'rgba(244,114,182,0.3)');
createParticles('particles18', 12, 'rgba(99,102,241,0.3)');
createParticles('particles19', 16, 'rgba(251,191,36,0.3)');
createParticles('particles20', 14, 'rgba(52,211,153,0.3)');
createParticles('particles21', 18, 'rgba(244,114,182,0.3)');
createParticles('particles22', 15, 'rgba(129,140,248,0.3)');
createParticles('particles23', 12, 'rgba(251,191,36,0.3)');
createParticles('particles24', 16, 'rgba(52,211,153,0.3)');
createParticles('particles25', 20, 'rgba(129,140,248,0.4)');
